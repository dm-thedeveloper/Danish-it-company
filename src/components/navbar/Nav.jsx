    ...
    <>
      ...
      >
        ...
        <nav className="md:px-10 px-6 flex items-center h-full ">
          ...
          <motion.div className="flex-1 items-center h-full md:flex hidden justify-end space-x-6">
            {links.map((link) => (
              <motion.div
                    ...
                    ` ${
                      bgTransparent
                        ? `text-white  px-1 rounded-md   backdrop-blur-md hover:backdrop-blur-xl  py-[2px] border border-[rgba(255,255,255,0)] shadow-sm  hover:mb-2   duration-200  flex justify-center items-center  ${
                            isActive ? "shadow-sm border border-white " : ""
                          }`
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                ` ${
                  bgTransparent
                    ? `text-black   px-1 rounded-md hover:backdrop-blur-xl  py-[2px] flex contact-btn duration-150 border justify-center items-center  ${
                        isActive ? " bg-transparent text-white" : "bg-white"
                      }`
                    : ` hover:opacity-80 flex justify-center items-center border border-appOrange  px-1 text-xl rounded-md   py-[2px] ${
                        isActive
                          ? "bg-transparent text-appOrange"
          ...
          <div className="flex-1 h-full  md:hidden flex items-center justify-end">
            <motion.button
              ...
              className={`text-lg  h-8 w-8 rounded-md  flex justify-center items-center ${
                bgTransparent
                  ? "border-[2px] backdrop-blur-lg text-white "
                  : "bg-appOrange text-white"
              }`}
            >
              {isOpen ? (
        ...
        <div className="min-h-[300px]  h-auto  w-full flex justify-center space-y-6 items-center flex-col  text-3xl  py-7">
          {links.map((link) => (
            <NavLink
              ...
              key={link.text}
              className={({ isActive }) =>
                `px-5 flex text-appOrange justify-center items-center ${
                  isActive
                    ? "border-l-2 border-r-2 border-appOrange rounded-full"
                    : ""
                } `
              }
            >
