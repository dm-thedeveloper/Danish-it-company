    ...
    <>
      <section className="h-auto w-full">
        ...
        <section
          ...
          style={{
            backgroundImage:
              "url(https://res.cloudinary.com/dfyfvcrkd/image/upload/v1740897092/Danish%20IT/uwhewvmhrlac7xo6qyeo.jpg)",
...
const DTHGlanceSection = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://res.cloudinary.com/dfyfvcrkd/image/upload/v1740897091/Danish%20IT/po6gm01jjcxjvbtbk1b2.avif')",
      }}
    >
      {/* Overlay */}
